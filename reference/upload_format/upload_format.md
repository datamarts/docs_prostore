...
* Если данные предназначены для логических таблиц, последним полем схемы должно быть указано служебное поле `sys_op` 
  с типом данных int. В данных, предназначенных для 
  [внешних writable-таблиц](../../overview/main_concepts/external_table/external_table.md#writable_table), поле `sys_op` 
...
* Если данные предназначены для логических таблиц, в каждой записи последним полем должно быть указано служебное поле 
  ...
  существующую запись). В данных, предназначенных для внешних writable-таблиц, поле `sys_op` должно отсутствовать.

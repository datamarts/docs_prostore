...
*   `JOIN [INNER]` — внутреннее соединение,
*   `JOIN NATURAL` — внутреннее соединение по всем столбцам с одинаковыми именами, ключи соединения 
    не указываются,
*   `JOIN LEFT [OUTER]` — левое внешнее соединение,
*   `JOIN RIGHT [OUTER]` — правое внешнее соединение,
*   `JOIN FULL [OUTER]` — полное внешнее соединение,
*   `JOIN CROSS` — декартово произведение таблиц или представлений, ключи соединения не указываются.

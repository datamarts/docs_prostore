...
по условию. 
Записи становятся архивными и при этом остаются доступными для чтения и выгрузки. 
...
Чтобы окончательно удалить (очистить) некоторые записи логической таблицы, используйте запрос 
[TRUNCATE HISTORY](../TRUNCATE_HISTORY/TRUNCATE_HISTORY.md). Очистить все записи таблицы можно, 
...
*   `filter_expression` — условие выбора удаляемых записей. Если ключевое слово WHERE и условие не указаны, 

...
INSERT INTO sales.payments_ext_write 
VALUES (100, 111111, 'MONTH_FEE', 2000, 643, 'Оплата ежемесячного взноса'), 
       (101, 222222, 'MONTH_FEE', 2000, 643, 'Оплата ежемесячного взноса');
```
...
VALUES (102, 333333, 'MONTH_FEE', 2000, 643), 
       (100, 111111, 'MONTH_FEE', 1500, 643);
```
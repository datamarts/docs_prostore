...
Контрольная сумма логической таблицы или материализованного представления в дельте рассчитывается в следующем порядке:
1. По каждой записи, загруженной в таблицу или в представление в этой дельте:
